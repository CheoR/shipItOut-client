...
export const TestForm = () => {
  ...
  const handlePickupDateChange = (e) => {
    ...
    console.log(
      `e.id: ${e.id} e.name: ${e.name} e.label: ${e.label} e.value: ${e.value}`,
    )
    ...
    <div style={{ margin: '0 auto', width: '60%', backgroundColor: 'red' }}>
      ...
      >
        <Grid
          container
          spacing={4}
          style={{ background: 'orange', width: '100%', margin: '0 auto ' }}
        >
          <Grid
            item
            xs={4}
          ...
          >
            ...
            >
              ...
              <FormHelperText>
                Be careful form vales pickup : {console.log(formValues.pickup)}{' '}
              </FormHelperText>
            </FormControl>
            <DateTimePicker
              style={{ width: '100%' }}
